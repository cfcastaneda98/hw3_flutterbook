...
class AppointmentsList extends StatelessWidget
{
  ...
  Widget build(BuildContext context)
  {
    ...
    for (int i = 0; i < appointmentsModel.entityList.length; i++) {
      ...
      if (appointment.date == null || appointment.date.isEmpty) {
                            ...
                            children: [
                              ...
                              Expanded(child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int inIndex) {
                                    ...
                                    if (appointment.date != "${inDate.year},${inDate.month},${inDate.day}") {
                                    ...
                                    endActionPane: ActionPane(
                                      ...
                                      children: [
                                        SlidableAction(
                                          ...
                                          icon: Icons.delete,
                                          onPressed: (inContext) => _deleteAppointment(context, appointment),
                                        ),
                                      ],
                                    ),
                                    child: Container(
  ...
  _editAppointment(BuildContext inContext, Appointment inAppointment) async
  {
    ...
    if (appointmentsModel.entityBeingEdited.date.length == 0) {
      appointmentsModel.setChosenDate('');
    } else {
      List dateParts = appointmentsModel.entityBeingEdited.date.split(",");
      DateTime apptDate = DateTime(
    ...
    if (appointmentsModel.entityBeingEdited.time.isEmpty) {
      appointmentsModel.setApptTime('');
    } else {
