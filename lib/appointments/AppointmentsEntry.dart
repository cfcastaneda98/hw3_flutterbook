...
class AppointmentsEntry extends StatelessWidget
{
                  ...
                  child: ListView(
                    children: [
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () async {
                            String chosenDate = await utils.selectDate(
                                inContext, appointmentsModel, appointmentsModel.entityBeingEdited.date
                            );

                            if (chosenDate != '') {
                              appointmentsModel.entityBeingEdited.date = chosenDate;
                            } else {
                              appointmentsModel.entityBeingEdited.date = DateTime.now();
                            }
                          },
                        ),
                      ),
                      ...
                      ListTile(
                        ...
                        subtitle: Text(appointmentsModel.time.isEmpty ?
                          '' :
  ...
  Future _selectTime(BuildContext inContext) async
  {
    ...
    if (appointmentsModel.entityBeingEdited.time.isNotEmpty) {
