...
import 'package:hw3_flutterbook/Recorder/RecorderList.dart';
import 'package:hw3_flutterbook/Recorder/RecorderView.dart';

class RecorderHomeView extends StatefulWidget {
  final String _title;

  const RecorderHomeView({Key key, String title})
      : _title = title,
        super(key: key);
